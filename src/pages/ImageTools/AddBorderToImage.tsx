...
export default function AddBorderToImage() {
  ...
  const handleProcessImages = async (
    ...
    try {
      ...
      toast.success("Border added to images successfully!");
      return files;
    } catch (error) {
  ...
  return (
    <WorkspaceLayout title="Add Border to Image">
      <ImageToolWorkflow
        ...
        resultDescription={(count) => `${count} image${count !== 1 ? "s" : ""} with border added`}
